...
export default function NavBarWhite() {
  ...
  return (
    <nav className="px-5 lg:px-[90px] py-[20px] relative z-40">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden lg:flex gap-3 dm-mono-medium capitalize">
          <Link
            to="/sign-up"
            className="py-[12px] px-[30px] rounded-lg capitalize text-sm text-primary bg-foundation transition-colors duration-300 hover:text-white hover:border-white hover:border"
          >
            SIGN UP
          </Link>
          <Link
