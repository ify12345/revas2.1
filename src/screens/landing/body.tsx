  ...
  return (
    <div className="">
      ...
      <div className="bg-custom-image flex flex-col lg:flex-row mx-4 lg:mx-[62px]  rounded-[32px] my-[123px]">
        <div className="flex flex-col p-[20px] lg:p-[58px]">
          <div className="max-w-[369px] w-full text-6xl font-bold">
            Get Started in Minutes
          </div>
          <p className="pl-[38px] border-l-2 border-[#5B4397] text-2xl font-[500] max-w-[349px] mt-[30px] mb-[24px]">
          ...
          <p className="pl-[38px] text-2xl font-[500]  mt-[30px] mb-[24px]">
