        ...
        <form action="" className='text-[#98A2B3] flex flex-col gap-[24px]'>
          ...
          <div className="w-full flex gap-[14px]">
            <div className="w-1/2">
              ...
              <input type="text" placeholder='first name' className='w-full border border-[#E2E8F0] py-[10px] px-2 rounded-md' />
            </div>
            <div className="w-1/2">
              <label htmlFor="">Last Name</label>
              <input type="text" placeholder='last name' className='w-full border border-[#E2E8F0] py-[10px] px-2 rounded-md' />
            </div>
          </div>
          <div className="w-full">
              <label htmlFor="">Role</label>
              <input type="text" placeholder='Manager' className='w-full border border-[#E2E8F0] py-[10px] px-2 rounded-md' />
            </div>
          <div className="w-full">
          ...
          <div className="w-full">
              ...
              <Link className='py-2.5 rounded-md bg-primary text-[#fff] justify-center items-center flex' to="/sign-in">Get started</Link>
